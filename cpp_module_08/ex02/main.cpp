...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/16 19:15:05 by iugolin           #+#    #+#             */
/*   Updated: 2023/10/18 17:53:52 by iugolin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "<---------vector_testing--------->" << std::endl;
	{
		...
		std::cout << "Size of new copied vector: " << s.size() << std::endl;
		std::cout << "Last element is: " << s.back() << std::endl;
	}
	return 0;
}
